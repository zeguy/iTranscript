    ...
    $.fn.playerConnect = function(player){
        ...
        player.onTime(function(evt){
                ...
                transcriptElements.each(function() {
                    ...
                    //console.log(parseFloat($(this).attr('data-dur')));
                    if (time >= parseFloat($(this).attr('data-start')) && time <= (parseFloat($(this).attr('data-start')) + parseFloat($(this).attr('data-dur')))){
                        $(this).attr("class","hilight");
                    }else{$(this).removeAttr("class","hilight");}
                });
                // YOUR CODE TO ADD #3
        });
